      ...
      <div className="min-h-screen flex items-center justify-center">
        ...
        <div className="space-y-6 pt-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap">
            ...
            {!isConnected ? <Button variant="cosmic" size="lg" onClick={handleWalletAction} disabled={isConnecting} className="min-w-[200px] text-lg font-semibold">
                ...
                <div className="bg-background/10 backdrop-blur-sm border border-primary/20 rounded-lg p-4 space-y-3">
                  ...
                  <div className="space-y-2">
                    ...
                    {chainId && <div className="text-xs text-muted-foreground">
          ...
          <div className="max-w-3xl mx-auto text-center space-y-4">
            ...
            {!isConnected && <p className="text-sm text-muted-foreground/80">
          ...
          {isConnected && <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-6 max-w-6xl mx-auto">
